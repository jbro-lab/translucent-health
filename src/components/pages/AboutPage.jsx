        ...
        <Paper sx={{
            ...
            <div sx={{
                ...
                <Grid item xs={12} md={6}>
                    <Typography variant="h3" sx={{ fontColor: "black", fontWeight: 700, mb: 'calc(1rem + 1vw)' }}>
                    We're trying to publish health costs. It's a pretty big deal.
                    </Typography>
                    <Typography variant="h5" sx={{ fontWeight: 700, mb: 'calc(0.5rem + 1vw)', lineHeight: '1.2' }}>
                    ...
                    <Typography variant="body1" sx={{ mb: 'calc(1rem + 1vw)' }}>
                    Somehow, everyone knows this is an issue, but nobody does anything about it. We take the published costs from hospitals (which are difficult to find and near impossible to search) and put them into an easy-to-use application, that hopefully helps at least a little with knowing more about healthcare prices. Needing health care sucks enough, we aim to help you know your costs.
                    </Typography>
                </Grid>
                </Grid>
            </Container>
